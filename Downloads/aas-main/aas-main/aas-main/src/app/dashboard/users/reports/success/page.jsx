...
export default function ReportSuccessPage() {
  ...
  const getShareUrl = () => `${window.location.origin}/dashboard/users/reports/success?id=${report?.id || reportId}`;
        ...
        <DashboardLayout>
          <div className="max-w-md mx-auto text-center py-16 bg-white rounded-2xl shadow p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/dashboard/users" className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                Kembali ke Dashboard
              </Link>
              <Link href="/dashboard/users/reports/new" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                Buat Laporan Baru
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-green-100 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                <Link href="/dashboard/users" className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition">
                  <Home size={18} /> Dashboard
                </Link>
                <Link href={`/dashboard/users/reports/${report.id}`} className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition shadow-md">
                  <FileText size={18} /> Detail Laporan
                </Link>
                <Link href="/dashboard/users/reports/new" className="inline-flex items-center gap-2 px-5 py-2.5 border border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition">
