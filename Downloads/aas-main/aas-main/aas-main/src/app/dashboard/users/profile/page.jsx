...
export default function UserProfilePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await apiFetch('/user/user/profile', { method: 'PUT', body: JSON.stringify(form) });
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-2 border rounded-xl focus:ring-blue-500 overflow-visible" 
                    required 
                  />
                </div>
              </div>
